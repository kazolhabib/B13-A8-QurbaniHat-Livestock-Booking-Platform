...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-[80vh] flex items-center justify-center bg-[#fcfcfc] px-4 py-12">
      <div className="max-w-md w-full bg-white p-8 rounded-3xl shadow-lg border border-gray-100 mt-10 mb-10 animate__animated animate__fadeInUp">
        ...
        <form onSubmit={handleRegister} className="space-y-5">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-4 mt-2 bg-[#253237] text-white font-bold rounded-xl hover:bg-[#FFCC4D] hover:text-[#253237] transition-all duration-300 disabled:opacity-70 disabled:cursor-not-allowed flex items-center justify-center gap-2"
          >
        ...
        <p className="mt-8 text-center text-sm text-gray-600">
          ...
          <Link href="/login" className="text-[#253237] font-bold hover:underline">
            Login here
          </Link>
        </p>
      </div>
